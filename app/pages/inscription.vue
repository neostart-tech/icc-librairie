<template>
  <div class="min-h-screen flex items-center justify-center bg-[#6a0d5f] px-4 py-10" style="background-image: radial-gradient(rgba(255,255,255,0.08) 1px, transparent 1px); background-size: 28px 28px;">
    
    <!-- Card principale split-screen -->
    <div v-reveal class="w-full max-w-5xl bg-white rounded-2xl overflow-hidden shadow-2xl flex flex-col md:flex-row">
