<template>
  <aside class="w-64 bg-white border-r h-screen px-4 py-6 flex flex-col fixed top-0 left-0">
    ...
    <nav class="flex-1 space-y-1 text-sm">
      ...
      <NuxtLink
        to="/admin"
        class="flex items-center px-3 py-2 rounded-lg text-gray-700 hover:bg-gray-100 transition"
      ...
      <div>
        <button
          ...
          class="w-full flex items-center justify-between px-3 py-2 rounded-lg text-gray-700 hover:bg-gray-100 transition cursor-pointer"
        >
          <div class="flex items-center">
            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <rect x="3" y="7" width="18" height="12" rx="2" ry="2" stroke-width="2"/>
              <path d="M3 13h18" stroke-width="2" stroke-linecap="round"/>
            </svg>
            <span>Produits</span>
          </div>
          <svg
        ...
        <div v-show="openProduits" class="ml-9 mt-1">
          ...
          <NuxtLink
            ...
            class="flex items-center px-3 py-1.5 rounded-md text-gray-700 hover:bg-black hover:text-[#6a0d5f] transition"
          >
      ...
      >
        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <rect x="4" y="14" width="16" height="4" rx="1" ry="1" stroke-width="2"/>
        </svg>
      ...
      >
        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path d="M3 3h18l-2 13H5L3 3z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M16 11H8" stroke-width="2" stroke-linecap="round"/>
        </svg>
        <span>Commandes</span>
      </NuxtLink>
      ...
      >
        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <path d="M6 20c0-3.333 2.667-6 6-6s6 2.667 6 6" stroke-width="2" stroke-linecap="round"/>
        </svg>
