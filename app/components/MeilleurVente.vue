<template>
  <section class="max-w-7xl mx-auto px-16 pt-4 pb-10">
    <!-- TITRE -->
    <div class="flex items-center justify-between mb-8">
      <h2 class="text-2xl font-semibold text-[#4A2B69]">
        Meilleurs ventes
      </h2>
...
const books = [
  ...
  {
    title: 'Espoir & renaissance',
    author: 'Paul A.',
    price: 11000,
    slug: 'espoir-renaissance',
    image: '/images/i1.jpg'
  },
  {
